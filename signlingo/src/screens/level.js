...
class Level extends Component {
    constructor(props) {
      super(props);
      this.state = {level1: 0, level2:0, level3: 0};
    } 
    componentDidMount(){
        
        this.setState({level1: parseInt(window.sessionStorage.getItem("level1"))});
        this.setState({level2: parseInt(window.sessionStorage.getItem("level2"))});
        this.setState({level3: parseInt(window.sessionStorage.getItem("level3"))});
    }
      render() {
        if (window.sessionStorage.getItem("userid") == null){
          ...
          <div style={{backgroundColor:'#FFFFFF', marginTop:'-1%', display:'block', height:'88vh'}}>
           ...
           <h1 style={{fontFamily:'Helvetica', fontSize:30, color:'#274968'}}>Level 1</h1><br/>
            <img src={L1}></img>
            <h1 style={{fontFamily:'Helvetica', fontSize:25, color:'#274968'}}>{this.state.level1} points earned</h1>
            </div></Link>
           ...
           <h1 style={{fontFamily:'Helvetica', fontSize:30, color:'#274968'}}>Level 2</h1><br/>
            <img src={L2}></img>
            <h1 style={{fontFamily:'Helvetica', fontSize:25, color:'#717171'}}>{this.state.level2} points earned</h1>
            </div></Link>
           ...
           <h1 style={{fontFamily:'Helvetica', fontSize:30, color:'#274968'}}>Level 3</h1><br/>
            <img src={L3}></img>
            <h1 style={{fontFamily:'Helvetica', fontSize:25, color:'#717171'}}>{this.state.level3} points earned</h1>
            </div></Link>
